...
data= {'tecnico':"",'labor':"",'nodo':"",'ubicacion':""}
...
def paso4(update, context):
	...
	labor:{}
	nodo:{}
	ubicación:{}""".format(data['tecnico'], data['labor'],data['nodo'], data['ubicacion'])

	update.message.reply_text(msg)

	
	text="Según técnico {}, se amerita {}".format(nombres[data["tecnico"]],data['ubicacion'])
	k = EmailMessage()
	k.set_content(text)

	k['Subject'] = "{} en {}".format(data['labor'], data['nodo'])
	k['From'] = sender_email
	k['To'] = receiver_email
